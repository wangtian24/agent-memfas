"""
MiniMax summarization implementation.

Condenses medium-relevance chunks using MiniMax API.
"""
...
Summarize this chunk:"""
    ...
    def summarize_batch(
        ...
        summaries = []
        for chunk in chunks:
            summary = self.summarize(chunk, prompt, preserve_keywords)
...
def create_minimax_summarizer(
    api_key: str = None,
    config_path: str = None,
    **kwargs,
) -> MiniMaxSummarizer:
    """
    Factory function to create MiniMax summarizer.
    
    Args:
        api_key: API key, or load from config/env
        config_path: Path to config file
        **kwargs: Additional arguments for MiniMaxSummarizer
    ...
    return MiniMaxSummarizer(api_key=api_key, **kwargs)
